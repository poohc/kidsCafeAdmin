	...
	<div class="wrapper" id="wrapper">
		...
		<div id="contents" class="contentBox">
			...
			<div class="contentSection">
				<h2>일별매출</h2>
				<form id="frm" action="${pageContext.request.contextPath}/sales/salesMonthly.view" method="post">
				<input type="hidden" id="localName" name="localName" value="${localName}">
				<input type="hidden" id="salesType" name="salesType" value="monthly">
				<!--  searchBox -->
				<div class="searchBox">
					<!--menuBox-->
					<c:import url="../common/menuDeatil.jsp">
						<c:param name="menuName" value="salesMenu" />
						<c:param name="menuSelected" value="monthly" />
					</c:import>
					<!--//menuBox-->
					<table>
						<colgroup>
				...
				<div class="dfTable">
					<div class="tit_info2">
						<h3>
							<span>${searchYear}년 월별 ${localName}</span>매출
						</h3>
					</div>
					<table>
						<colgroup>
